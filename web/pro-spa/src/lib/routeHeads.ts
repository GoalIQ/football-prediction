...
export const UCL_HEAD = {
	...
	description:
		'Projected points for players in the official UEFA Champions League Fantasy game, up to three matchdays ahead in the league phase, with captain, value and differential lists. GoalIQ Premium.'
} as const;

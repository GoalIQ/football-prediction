...
NEW_LOG = {
    "meta": {
        ...
        "rules": (
            ...
            "row can be updated until its deadline and never after it. From "
            "GW3 on, logged_at is the first write and updated_at the last "
            "write before the deadline. Scores are provisional until FPL "
            "confirms bonus points."),
    },
    "gameweeks": [],
}

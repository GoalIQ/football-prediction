    ...
    return [
        ...
        (
            ...
            (
                ...
                "that searches for the strongest 15 around your must-have players, "
        ...
        (
            ...
            (
                ...
                "must-have players, the model searches for the strongest 15 "
                "around them), price watch, a per-gameweek points table where each player's actual FPL points sit next to the expected points the model published before that deadline, "
...
<p class="note">The model's squad is frozen before every deadline. We play it in FPL as
entry 116920, with our own chip calls and the occasional lineup change, and that's the team
to beat in the <a href="https://fantasy.premierleague.com/leagues/auto-join/jgi6j9" data-cta="league">Beat
the Model mini-league</a> (code <strong>jgi6j9</strong>). Season winner gets a year of
...
<a href="/ucl/" data-cta="fpl-ucl">UCL Fantasy prices and squad news</a> (UEFA feed data),
...
<ul class="toollist">
  ...
  <li><a href="/fpl/model-xi">Model XI</a>: the best 15 our numbers fit in 100.0m. Not the model's gameweek squad, which is frozen before each deadline.</li>
    ...
    if xp:
        ...
        if _entry_gw:
            _entry_link = (
                ...
                'data-cta="index-model-entry">Our FPL entry, 116920 '
                "&#9656;</a>")
            new, n_me = re.subn(
